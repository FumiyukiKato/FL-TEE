...
sgx_status_t ecall_secure_aggregation(uint32_t fl_id, uint32_t round, uint32_t* client_ids, size_t client_size, uint8_t* encrypted_parameters_data, size_t encrypted_parameters_size, size_t num_of_parameters, size_t num_of_sparse_parameters, uint32_t aggregation_alg, float* updated_parameters_data, float* execution_time_results);
sgx_status_t ecall_client_size_optimized_secure_aggregation(uint32_t fl_id, uint32_t round, size_t optimal_num_of_clients, uint32_t* client_ids, size_t client_size, uint8_t* encrypted_parameters_data_ptr, size_t num_of_parameters, size_t num_of_sparse_parameters, uint32_t aggregation_alg, float* updated_parameters_data, float* execution_time_results);
sgx_status_t ecall_fl_init(uint32_t fl_id, uint32_t* client_ids, size_t client_size, size_t num_of_parameters, size_t num_of_sparse_parameters, float sigma, float clipping, float alpha, float sampling_ratio, uint32_t aggregation_alg, uint8_t verbose, uint8_t dp);
sgx_status_t ecall_start_round(uint32_t fl_id, uint32_t round, uint32_t sample_size, uint32_t* client_ids);
